package com.blacar.spike.server;
...
public class EmbeddedJetty {
    ...
    private static final String CONFIG_LOCATION_PACKAGE = "com.blacar.spike.config";
    ...
    private static ServletContextHandler getServletContextHandler() {
        ServletContextHandler contextHandler = new ServletContextHandler(ServletContextHandler.NO_SESSIONS); // SESSIONS requerido para JSP
